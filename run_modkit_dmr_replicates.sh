...
modkit dmr pair \
  ...
  -b /prj/TRR319_RMaP_BaseCalling_RNA004/Adrian/HEK293_psU-KD/modkit042/${cond1}.cov10.bedmethyl.gz \
  -o ${out_dir}/${cond0}_${cond1}_replicates.cov10.${mod}.dmr \
  --ref ${ref} \
  --base ${base} \
  --threads 36 \
  --log-filepath ${out_dir}/${cond0}_OE_${cond1}_KD_replicates.cov10.${mod}.log
